...
const About = () => {
  ...
  return (
    <section id="about" className="pt-20 pb-16 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Développeur passionné avec une approche moderne du développement
            web. J'aime créer des expériences utilisateur exceptionnelles.
          </p>
        </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-lg h-full">
              ...
              <div className="space-y-3 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                <p>
                  ...
                  j'ai acquis une solide expérience dans la création
                  d'applications web modernes et performantes.
                </p>
                <p>
                  Mon approche se base sur une veille technologique constante et
              ...
              {skillsData.map((skill, index) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    <div
                      className={`p-2 rounded-lg bg-gradient-to-r ${skill.color} text-white group-hover:scale-110 transition-transform`}
                    >
                      {skill.icon}
                    </div>
